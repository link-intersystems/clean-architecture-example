...
CREATE TABLE PUBLIC.CAR_BOOKING (
	BOOKING_NUMBER BIGINT auto_increment NOT NULL ,
	CARID CHAR(17) NOT NULL,
	CUSTOMER_ID BIGINT NOT NULL ,
	PICKUP_DATETIME TIMESTAMP NOT NULL,
	RETURN_DATETIME TIMESTAMP NOT NULL,
	CONSTRAINT CAR_BOOKING_PK PRIMARY KEY (BOOKING_NUMBER),
	CONSTRAINT CAR_BOOKING_FK FOREIGN KEY (CARID) REFERENCES PUBLIC.CAR(VIN)
);



INSERT INTO PUBLIC.CAR (VIN,NAME,VEHICLE_TYPE,SEATS,DOORS,FUEL_TYPE,CONSUMPTIONUNITS) VALUES
	 ('WMEEJ8AA3FK792135','Smart Fortwo','MICRO',2,2,'PETROL',5.00),
...
INSERT INTO PUBLIC.RENTAL_CAR (CARID,RATE_PER_DAY) VALUES
	 ('WMEEJ8AA3FK792135',89.99),
	 ('3C3CFFBR3CTR12014',95.00),
	 ('WBAFR1C54BCC47391',116.98),
	 ('YV4952CYXE1702329',165.99),
	 ('WDDHF5GB7CA482637',120.96);

INSERT INTO PUBLIC.CAR_BOOKING (BOOKING_NUMBER, CARID, CUSTOMER_ID, PICKUP_DATETIME,RETURN_DATETIME) VALUES
	 (1, 'WMEEJ8AA3FK792135', 1, '2023-01-15 08:00:00','2023-01-17 17:00:00'),
	 (2, 'WMEEJ8AA3FK792135', 1, '2023-01-19 08:00:00','2023-01-20 08:00:00');
