...
public class DBUnitCarOfferRepository implements CarOffersRepository {
    ...
    public DBUnitCarOfferRepository() {
        ...
        loadDataSet("/com/link_intersystems/car/Car.xml");
        loadDataSet("/com/link_intersystems/car/offers/CarBooking.xml");
        loadDataSet("/com/link_intersystems/car/rental/RentalCar.xml");
    }
