...
class JpaReturnCarRepositoryIntTest extends AbstractJpaManagementRepositoryTest {

    private ReturnCarRepository repository;

    @BeforeEach
    void setUp(Connection connection) {
        repository = testProxy(ReturnCarRepository.class, new JpaReturnCarRepository(entityManager));
    }
