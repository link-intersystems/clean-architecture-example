...
@H2Config(databaseSetup = CarRentalAccountDBExtension.CarRentalDBSetup.class)
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.TYPE)
public @interface CarRentalAccountDBExtension {
    class CarRentalDBSetup implements DBSetup {
        ...
        public void setupDdl(Connection connection) throws SQLException {
            InputStream resourceAsStream = CarRentalDBSetup.class.getResourceAsStream("/com/link_intersystems/carrental/account/init.sql");
