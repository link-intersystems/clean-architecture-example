...
class H2LoginRepositoryIntTest {
    ...
    void isLoginExistent() {
        Customer customer = loginRepository.findCustomer(new Login("rene.link", new SecurePassword("rene".toCharArray())));
    ...
    void isLogingNotExistent() {
        Customer customer = loginRepository.findCustomer(new Login("rene.link", new SecurePassword("link".toCharArray())));
